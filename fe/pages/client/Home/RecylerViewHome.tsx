...
import { StyleSheet, View, Text, FlatList, SafeAreaView, Dimensions, Image, TouchableOpacity } from 'react-native';
...
const VerticalRecyclerView: React.FC<VerticalRecyclerViewProps> = ({ data, onPress }) => {
  const renderItem = ({ item }: { item: DataItem }) => (
    <TouchableOpacity style={styles.verticalItemContainer} onPress={() => onPress(item)}>
